      ...
      {open && (
        <div className="pointer-events-none fixed inset-x-0 bottom-32 z-50 flex justify-center">
          <div
            ...
            className="pointer-events-auto grid grid-cols-2 gap-2.5 rounded-2xl bg-white/95 p-2.5 shadow-xl"
            style={{ minWidth: 220 }}
          >
            {options.map((opt, i) => {
              const Icon = opt.icon;
              return (
                ...
                >
                  ...
                  <span className="text-[11.5px] font-semibold leading-tight">{opt.label}</span>
                </button>
              );
            })}
          </div>
