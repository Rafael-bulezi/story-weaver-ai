...
import { useBooks, type Branch } from "@/lib/story-store";
import { type NavTab } from "@/components/story/BottomNav";
import { cn } from "@/lib/utils";

export type ComposerMode = "chat" | "brainstorm" | "worldbuild" | "outline";
...
export function SidebarNav({
  ...
  const [activeSection, setActiveSection] = useState<"library" | "recent" | "favorites">("library");
